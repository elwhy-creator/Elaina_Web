...
@elaina.route('/konosuba')
def konosuba_page():
    return render_template('konosuba.html')

@elaina.route('/dandadan')
def dandadan_page():
    return render_template('dandadan.html')

@elaina.route('/drstone1')
def drstone1_page():
    return render_template('drstone1.html')

@elaina.route('/drstone2')
def drstone2_page():
    return render_template('drstone2.html')

@elaina.route('/meliodas')
def meliodas_page():
    return render_template('meliodas.html')

@elaina.route('/hyouka')
def hyouka_page():
    return render_template('hyouka.html')
